...
#start the measure
class ChangeInsulationRValueForExteriorWalls < OpenStudio::Ruleset::ModelUserScript

  #define the name that a user will see
  def name
    return "Change R-value of Insulation for Exterior Walls to a Specific Value"
  end
  
  # human readable description
  def description
    return "This measure aims to change R-value of exterior walls."
  end

  # human readable description of modeling approach
  def modeler_description
    return "Modify the R-value of exterior walls."
  end
...
ChangeInsulationRValueForExteriorWalls.new.registerWithApplication