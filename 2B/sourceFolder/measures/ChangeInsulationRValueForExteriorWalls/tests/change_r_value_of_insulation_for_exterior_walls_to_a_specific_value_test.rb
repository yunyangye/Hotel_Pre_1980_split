...
class ChangeRValueOfInsulationForExteriorWallsToASpecificValueTest < MiniTest::Unit::TestCase
  ...
  def test_number_of_arguments_and_argument_names
    ...
    measure = ChangeRValueOfInsulationForExteriorWallsToASpecificValue.new
